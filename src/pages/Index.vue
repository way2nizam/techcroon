  ...
  <q-layout view="lHh lpr lFf">
      ...
      <q-toolbar>
        ...
        <q-tabs v-model="selected_tab" shrink>
          ...
          <q-btn
            ...
            size="12px"
            :style="
              'min-height:auto !important;background:' +
              theme_color +
    ...
    <q-page-container>
      <q-page>
        ...
        >
            ...
            >
              <div class="custom-caption">
                <div class="text-h2 main_line animation_2">
                  WELCOME TO
                  <span :style="'color:' + theme_color">Techcroon</span>
                </div>
                <br /><br /><br />
          ...
          >
            ...
            >
              <div class="custom-caption">
                <div
                  class="text-h2 main_line animation_2"
                  style="font-size: 65px"
                >
                  <span :style="'color:' + theme_color">Techcroon</span> FOR THE
                  BEST
                </div>
                <br /><br /><br />
                <div class="text-h4 animation_1">
          ...
          >
            ...
            >
              <div class="custom-caption">
                ...
                >
                  THE PATH OF
                  <span :style="'color:' + theme_color">SUCCESS</span>
                </div>
                <br /><br /><br />
                <div class="text-h4 animation_1">
                ...
                <span v-for="index in 6" :key="index">
                  <q-flashcard :no-hover="hover" :style="style">
                    ...
                    >
                      ...
                      <q-flashcard-section
                        transition="fade-in"
                        class="fit flex justify-center items-end q-pb-lg"
                        :active="active"
                      >
                        <q-btn
                          class="q-mr-md"
          ...
          >
            <div class="col-md-4 col-lg-4 col-sx-12 col-sm-12">
              <q-card
                ...
                style="border: none"
                class="my-card text-center box-shadow"
                flat
                bordered
              >
          ...
          <div style="background-color: #000000ad !important">
            ...
            >
              ...
              >
                <img
                  :style="
                    'margin-top:100px;border-radius:5px;border: 4px solid ' +
                    theme_color
                  "
                  src="/statics/images/team_1.jpg"
                  width="150"
                  height="150"
                />
        ...
        <div class="row text-center flex flex-center">
          <div
            class="col-md-12 col-lg-12 col-sx-12 col-sm-12 q-px-xl"
                ...
                >
                  <span v-for="index in 4" :key="index">
                    <q-flashcard :no-hover="hover" :style="team_style">
                      ...
                      >
                        <img
                          :src="'/statics/images/team_' + index + '.jpg'"
                          width="260"
                          height="263"
                        />
                      </q-flashcard-section>
            ...
            <div class="row q-col-gutter-sm q-px-xl">
              <div class="col-lg-3 col-md-3 col-xs-12 col-sm-6 q-px-lg">
                <q-card>
                  ...
                  >
                    <div class="text-h6 text-center">FREE</div>
                  </q-card-section>
                  ...
                  <q-card-section>
                    <div class="text-center q-px-lg">
                      <q-btn
                        ...
                        style="background: #ec982f; color: white"
                        label="Choose Plan"
                      />
                      <br />
              ...
              <div class="col-lg-3 col-md-3 col-xs-12 col-sm-6 q-px-lg">
                <q-card>
                  <q-card-section
                    class="text-white"
                    style="background: #f4655f"
                  >
                    <div class="text-h6 text-center">STANDARD</div>
                  </q-card-section>
                  <q-card-section class="q-pa-md">
                    <q-list
                      dense
              ...
              <div class="col-lg-3 col-md-3 col-xs-12 col-sm-6 q-px-lg">
                <q-card>
                  <q-card-section
                    ...
                    style="background: #8b3bbd"
                  >
                    <div class="text-h6 text-center">PREMIUM</div>
                  </q-card-section>
                  <q-card-section class="q-pa-md">
                    <q-list
                      dense
              ...
              <div class="col-lg-3 col-md-3 col-xs-12 col-sm-6 q-px-lg">
                <q-card>
                  <q-card-section
                    class="text-white"
                    style="background: #3b97d1"
                  >
                    <div class="text-h6 text-center">PROFESSIONAL</div>
                  </q-card-section>
                  <q-card-section class="q-pa-md">
                    <q-list
                      dense
        ...
        >
          <div class="q-pa-sm q-gutter-sm">
            ...
            <q-btn
              round
              type="a"
              href="mailto:techcroon@gmail.com"
              :style="
                'background:' + theme_color + '; color: white !important;'
              "
              icon="email"
