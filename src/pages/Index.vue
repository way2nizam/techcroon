<template>
  <q-layout view="lHh lpr lFf">
    <q-header class="q-py-sm" style="background-color: #1c1b21;" :style="'border-bottom: 2px solid '+ theme_color">
        <q-toolbar>
        <span :style="'font-size: 35px;color:'+theme_color" class="my-font text-h6 q-mr-md">TechCroon</span>
        <q-space ></q-space>
...
<div class="full-height full-width flex flex-center" style="background-color: rgba(0, 0, 0, 0.68) !important;">
            <div class="custom-caption">
              <div class="text-h2 main_line animation_2">WELCOME TO <span :style="'color:'+theme_color">TechCroon</span></div><br><br><br>
...
<div class="full-height full-width flex flex-center" style="background-color: rgba(0, 0, 0, 0.68) !important;">
            <div class="custom-caption">
    	      <div class="text-h2 main_line animation_2" style="font-size:65px;"><span :style="'color:'+theme_color">TechCroon</span> FOR THE BEST</div><br><br><br>
...
<!-- <q-btn size="md" :style="'background:'+ theme_color +'; color: white'" label="READ MORE"/> -->
        ...
        <div class="row">
          ...
          At Techcroon, we are committed to delivering cutting-edge technology solutions that drive growth and innovation. 
          Our team of experts works collaboratively to create products that not only meet your current needs but also anticipate future demands. Let's shape the future together.
              </q-card-section>
            </q-card>
          </div>
          <div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
            <q-card class="q-pa-sm flex flex-center text-center box-shadow" style="margin: 40px;">
              ...
              <q-card-section class="q-pt-none">
At Techcroon, we are dedicated to delivering high-quality graphic design solutions that elevate your brand. From striking visuals to cohesive branding, our team collaborates to create designs that not only capture attention but also leave a lasting impression. Let's bring your vision to life together.              </q-card-section>
            </q-card>
          </div>
          <div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
            <q-card class="q-pa-sm flex flex-center text-center box-shadow" style="margin: 40px;">
              ...
              <q-card-section>
                ...
                <div class="text-h6">Apps Development</div>

              </q-card-section>

              <q-card-section class="q-pt-none">
                At Techcroon, we specialize in developing high-performance apps that enhance user experience and drive engagement. From intuitive interfaces to seamless functionality, our team collaborates to create apps that not only meet your needs but also exceed expectations.
              </q-card-section>
            </q-card>
          </div>
          ...
          <div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
            <q-card class="q-pa-sm flex flex-center text-center box-shadow" style="margin: 40px;">
              ...
              <q-card-section>
                <q-icon size="110px" name="people" :style="'color:'+theme_color"/>
                <div class="text-h6">SEO/SMO</div>

              </q-card-section>

              <q-card-section class="q-pt-none">
               At Techcroon, we excel in delivering SEO and SMO strategies that boost visibility and drive traffic. From keyword optimization to social media engagement, our team collaborates to enhance your online presence and connect with your target audience.
              </q-card-section>
            </q-card>
          </div>
        </div>
        ...
        <div class="row" id="id_about_us">
          <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
            <h5 class="text-center">About Us
              <br>
              <span
                class="text-center text-grey text-h6">Techcroon is a forward-thinking development company specializing in creating innovative digital solutions.<br> With expertise in web and mobile app development, graphic design, and digital marketing strategies like SEO and SMO, Techcroon is dedicated to helping businesses thrive in the digital age.<br> Our team of experts collaborates closely with clients to deliver high-quality, tailored solutions that drive growth and enhance brand presence.</span>
            </h5>
          </div>
        </div>
          ...
          <div class="col-md-12 col-lg-12 col-sx-12 col-sm-12 q-gutter-md flex flex-center">
            <div class="col-md-4 col-lg-4 col-sx-12 col-sm-12">
              <q-card @mouseover="hoverOver(1)" @mouseout="hoverOutTimeout(1)" style="border: none;" class="my-card text-center box-shadow" flat bordered>
                ...
                <q-card-section>
                  <div class="text-overline text-orange-9">Commitment to Quality</div>
                  <div :class="about_heading_1" :style="'color: ' + about_heading_color_1" class="about_heading_1 text-h6 q-mt-sm q-mb-xs">Excellence</div>
                  <div class="text-caption text-grey-9">
                    Delivering high-quality services with a commitment to exceeding expectations in every project.
                  </div>
                </q-card-section>
              </q-card>
            </div>
            <div class="col-md-4 col-lg-4 col-sx-12 col-sm-12">
              <q-card @mouseover="hoverOver(2)" @mouseout="hoverOutTimeout(2)" :style="'color: ' + about_heading_color_2" style="border: none;" class="my-card text-center box-shadow" flat bordered>
                ...
                <q-card-section>
                  <div class="text-overline text-orange-9">Pioneering the Future</div>
                  <div :class="about_heading_2" :style="'color: ' + about_heading_color_2" class="text-h6 q-mt-sm q-mb-xs">Innovation</div>
                  <div class="text-caption text-grey-9">
                    Driving forward-thinking solutions that keep your business ahead of the curve.
                  </div>
                </q-card-section>
              </q-card>
            </div>
            <div class="col-md-4 col-lg-4 col-sx-12 col-sm-12">
              <q-card @mouseover="hoverOver(3)" @mouseout="hoverOutTimeout(3)" style="border: none;" class="my-card text-center box-shadow" flat bordered>
                ...
                <q-card-section>
                  <div class="text-overline text-orange-9">Partnering for Success</div>
                  <div :class="about_heading_3" :style="'color: ' + about_heading_color_3" class="text-h6 q-mt-sm q-mb-xs">Collaboration</div>
                  <div class="text-caption text-grey-9">
                    Partnering closely with clients to create customized, impactful digital experiences.
                  </div>
                </q-card-section>
              </q-card>
            </div>
          ...
          <div class="row">
            <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
              <h5 class="text-center">Our Services
                <br>
                <span
                  class="text-center text-grey text-h6">Comprehensive digital solutions, from web design and app development to graphic design, SEO, and digital marketing, all tailored to elevate your brand.</span>
              </h5>
            </div>
          </div> 
          <div class="q-pa-xl">       
              ...
              <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                <q-item class="box-shadow q-pa-none q-ml-xs ">
                  ...
                  <q-item-section class="q-pa-md q-ml-none">
                    <q-item-label class="text-h6 text-grey-9 text-uppercase">TECH CONSULATION</q-item-label>
                    <q-item-label class="text-grey-8">Expert tech consultation to guide your business through every stage of digital transformation.</q-item-label>
                  </q-item-section>
                </q-item>
              </div>
              <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                <q-item class="box-shadow q-pa-none q-ml-xs">
                  ...
                  <q-item-section class="q-pa-md q-ml-none">
                    ...
                    <q-item-label class="text-grey-8">Creative web design that transforms your vision into a stunning, user-friendly digital experience.</q-item-label>
                  </q-item-section>
                </q-item>
              </div>
              <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                <q-item class="box-shadow q-pa-none q-ml-xs q-mr-xs">
                  ...
                  <q-item-section class="q-pa-md q-ml-none">
                    <q-item-label class="text-h6 text-grey-9 text-uppercase">Graphic Designing</q-item-label>
                    <q-item-label class="text-grey-8">Eye-catching graphic design that brings your brand’s story to life with visual impact.</q-item-label>
                  </q-item-section>
                </q-item>
              </div>
            </div>
            <div class="row q-col-gutter-sm q-mt-lg">
              <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                <q-item class="box-shadow q-pa-none q-ml-xs ">
                  ...
                  <q-item-section class="q-pa-md q-ml-none">
                    <q-item-label class="text-h6 text-grey-9 text-uppercase">Apps Development</q-item-label>
                    <q-item-label class="text-grey-8">Custom app development that delivers seamless user experiences and drives engagement.</q-item-label>
                  </q-item-section>
                </q-item>
              </div>
              <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                <q-item class="box-shadow q-pa-none q-ml-xs">
                  ...
                  <q-item-section class="q-pa-md q-ml-none">
                    <q-item-label class="text-h6 text-grey-9 text-uppercase">Digital Marketing</q-item-label>
                    <q-item-label class="text-grey-8">Strategic digital marketing that boosts your online presence and connects with your audience.</q-item-label>
                  </q-item-section>
                </q-item>
              </div>
              <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                <q-item class="box-shadow q-pa-none q-ml-xs q-mr-xs">
                  ...
                  <q-item-section class="q-pa-md q-ml-none">
                    <q-item-label class="text-h6 text-grey-9 text-uppercase">SEO/SMO</q-item-label>
                    <q-item-label class="text-grey-8">Effective SEO and SMO strategies to maximize your visibility and enhance brand engagement.</q-item-label>
                  </q-item-section>
                </q-item>
              </div>
            </div>
...
<div class="row" id="id_news">
  <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
    <h5 class="text-center text-white">Contact Us
      <br>
      <span
        class="text-center text-grey text-h6">Get in touch with us today to start transforming your digital vision into reality.</span>
    </h5>
  </div>
</div>
